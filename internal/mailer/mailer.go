...
func (m Mailer) Send(recipient, templateFile string, data any) error {
	...
	//User the mail.NewMessage() function to initialize a new mail.Message instance.
	...
	//method to set the HTML boy. It's important to note that AddAlternative() should
